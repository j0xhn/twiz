...
- (void) answerSelected:(id)sender{
    ...
    [self.view removeFromSuperview]; // clears old tweet
...
- (void)resetActiveTweet
{
    ...
    [tweetLabel setFont:TWIZ_FONT_500_22];
    //sets left padding
...
#pragma mark - Possible Answers Display
    ...
    [possibleAnswer1 setFont:TWIZ_FONT_300_22];
    ...
    [author2 setFont:TWIZ_FONT_300_30];
    ...
    [author3 setFont:TWIZ_FONT_300_30];
    ...
    [author4 setFont:TWIZ_FONT_300_30];
